...
INSERT [dbo].[NHAN_VIEN] ([MaNhanVien], [TenNhanVien], [SoDienThoai], [Email], [TenDangNhap], [MatKhau], [MaVaiTro], [HinhAnh], [MaCa]) VALUES (1, N'Nguyễn Văn A', N'0911111111', N'a@gmail.com', N'user1', N'PBKDF2-SHA256$100000$F+NtCyvFEO4hiMPX3aj7WA==$5VwCFJ7SWbEICpUvtvyYBJg4kp/hwRfADqJ60PE07+Q=', 1, NULL, 1)
INSERT [dbo].[NHAN_VIEN] ([MaNhanVien], [TenNhanVien], [SoDienThoai], [Email], [TenDangNhap], [MatKhau], [MaVaiTro], [HinhAnh], [MaCa]) VALUES (2, N'Trần Văn B', N'0911111112', N'b@gmail.com', N'user2', N'PBKDF2-SHA256$100000$IypjWxbHuke68e5DOkRtkg==$ctkhilYujMiZU7swa7qnVie806ui7GqlokqFyld1pqE=', 2, NULL, 2)
INSERT [dbo].[NHAN_VIEN] ([MaNhanVien], [TenNhanVien], [SoDienThoai], [Email], [TenDangNhap], [MatKhau], [MaVaiTro], [HinhAnh], [MaCa]) VALUES (3, N'Lê Văn C', N'0911111113', N'c@gmail.com', N'user3', N'PBKDF2-SHA256$100000$Hai1Lnl8kLYufK/6r/mM7g==$YA0KtaTiwvW2ulEDU9oaYhY79PeFMBoMLs2SDbgF9OM=', 2, NULL, 3)
INSERT [dbo].[NHAN_VIEN] ([MaNhanVien], [TenNhanVien], [SoDienThoai], [Email], [TenDangNhap], [MatKhau], [MaVaiTro], [HinhAnh], [MaCa]) VALUES (4, N'Phạm Văn D', N'0911111114', N'd@gmail.com', N'user4', N'PBKDF2-SHA256$100000$yUkJeUT5UGW6flABpFOLqg==$BabEuLxKz1ZtjwRosfKk+k6ey5n5nB7rL0+v+24zA1c=', 2, NULL, 1)
INSERT [dbo].[NHAN_VIEN] ([MaNhanVien], [TenNhanVien], [SoDienThoai], [Email], [TenDangNhap], [MatKhau], [MaVaiTro], [HinhAnh], [MaCa]) VALUES (5, N'Hoàng Văn E', N'0911111115', N'e@gmail.com', N'user5', N'PBKDF2-SHA256$100000$JaVFl7WBOi6Rgb23DrnNmw==$7eDALzRHQPokUVg7HlArXcHp1L86T/0dJTc4h+eDzrI=', 2, NULL, 2)
INSERT [dbo].[NHAN_VIEN] ([MaNhanVien], [TenNhanVien], [SoDienThoai], [Email], [TenDangNhap], [MatKhau], [MaVaiTro], [HinhAnh], [MaCa]) VALUES (6, N'Đỗ Văn F', N'0911111116', N'f@gmail.com', N'user6', N'PBKDF2-SHA256$100000$P7wndEAg3QPev0mntm84uQ==$gp5z3hg9DC/pGZettvpje7F+fW/w86KPtyS3XmyCGpI=', 2, NULL, 3)
INSERT [dbo].[NHAN_VIEN] ([MaNhanVien], [TenNhanVien], [SoDienThoai], [Email], [TenDangNhap], [MatKhau], [MaVaiTro], [HinhAnh], [MaCa]) VALUES (7, N'Vũ Văn G', N'0911111117', N'g@gmail.com', N'user7', N'PBKDF2-SHA256$100000$7MskoujlB0coi4MFCYNIkw==$pTnVVqnD4SPJZWLrbl30yDYfx/tqaDssECeURIW0Lug=', 2, NULL, 1)
INSERT [dbo].[NHAN_VIEN] ([MaNhanVien], [TenNhanVien], [SoDienThoai], [Email], [TenDangNhap], [MatKhau], [MaVaiTro], [HinhAnh], [MaCa]) VALUES (8, N'Bùi Văn H', N'0911111118', N'h@gmail.com', N'user8', N'PBKDF2-SHA256$100000$ROaZ78FJcBY8LkgVQJ2+VQ==$6W68oAOXHtBgCUgafqdJcfN9moCyYSj544T6wAH58Vk=', 2, NULL, 2)
INSERT [dbo].[NHAN_VIEN] ([MaNhanVien], [TenNhanVien], [SoDienThoai], [Email], [TenDangNhap], [MatKhau], [MaVaiTro], [HinhAnh], [MaCa]) VALUES (9, N'Phan Văn I', N'0911111119', N'i@gmail.com', N'user9', N'PBKDF2-SHA256$100000$R9+2rmidtiXq/BtEMtXWOg==$OtkuWgyX3EfndyrF5NamcGiJpRlzcZRCItideSpJb7Y=', 2, NULL, 3)
INSERT [dbo].[NHAN_VIEN] ([MaNhanVien], [TenNhanVien], [SoDienThoai], [Email], [TenDangNhap], [MatKhau], [MaVaiTro], [HinhAnh], [MaCa]) VALUES (10, N'Ngô Văn K', N'0911111120', N'k@gmail.com', N'user10', N'PBKDF2-SHA256$100000$GSxsO0jGFxWLx0Dnbbgbag==$L1kd03FK131Z9quR7u+gEqm6ED2dP2vF6ZC/GQ5uPkA=', 2, NULL, 1)
